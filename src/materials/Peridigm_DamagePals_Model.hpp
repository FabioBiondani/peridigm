...
#ifndef PERIDIGM_DAMAGEPALS_MODEL_HPP_
#define PERIDIGM_DAMAGEPALS_MODEL_HPP_
...
class DamagePals_Model : public Material {
public:

	typedef PeridigmNS::InfluenceFunction::functionPointer FunctionPointer;

	//! Constructor.
	DamagePals_Model(const Teuchos::ParameterList & params);

	//! Destructor.
	virtual ~DamagePals_Model();

	//! Return name of material type
	virtual std::string Name() const { return("Damage Pals"); }
